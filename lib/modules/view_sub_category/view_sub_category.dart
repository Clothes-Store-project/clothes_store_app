...
class ViewSubCategoryScreen extends StatelessWidget {
  ...
  const ViewSubCategoryScreen({required this.subCategoryId, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => ViewSubCategoryCubit()..getProducts(subCategoryId: subCategoryId),
