...
class ViewSectionProductScreen extends StatelessWidget {
  ...
  const ViewSectionProductScreen(
      {required this.categoryId, Key? key, required this.categoryName})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => ViewSectionProductCubit()
        ..getProducts(categoryId: categoryId),
      child: BlocConsumer<ViewSectionProductCubit, ViewSectionProductStates>(
          listener: (context, state) {},
          builder: (context, state) {
            ViewSectionProductCubit cubit =
                ViewSectionProductCubit.get(context);
